...
app.post('/transcribe', upload.single('audio'), async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: 'Error transcribing audio.', details: error.message });
  }
});
...
//         console.log(transcript);
//  //       res.set('Content-Type', 'text/plain');
//         res.json({transcript: parsedData, original: transcript})
...
// app.post('/addMissing', upload.single('audio'), async (req, res) => {
